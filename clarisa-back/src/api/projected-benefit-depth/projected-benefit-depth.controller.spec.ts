...
describe('ProjectedBenefitDepthController', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        { provide: ProjectedBenefitDepthService, useValue: mockProjectedBenefitDepthService },
      ],
    }).compile();
  ...
  it('should be defined', () => {
    ...
    it('should call service on findAll', async () => {
      mockProjectedBenefitDepthService.findAll = mockProjectedBenefitDepthService.findAll || jest.fn();
    ...
    it('should call service on findOne', async () => {
      mockProjectedBenefitDepthService.findOne = mockProjectedBenefitDepthService.findOne || jest.fn();
    ...
    it('should call service on update', async () => {
      mockProjectedBenefitDepthService.update = mockProjectedBenefitDepthService.update || jest.fn();
