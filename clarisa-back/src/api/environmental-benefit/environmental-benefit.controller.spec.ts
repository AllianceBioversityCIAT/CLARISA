...
describe('EnvironmentalBenefitController', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        {
          provide: EnvironmentalBenefitService,
          useValue: mockEnvironmentalBenefitService,
        },
      ],
    }).compile();
  ...
  it('should call service on findAll', async () => {
    mockEnvironmentalBenefitService.findAll =
      mockEnvironmentalBenefitService.findAll || jest.fn();
  ...
  it('should call service on findOne', async () => {
    mockEnvironmentalBenefitService.findOne =
      mockEnvironmentalBenefitService.findOne || jest.fn();
  ...
  it('should call service on update', async () => {
    mockEnvironmentalBenefitService.update =
      mockEnvironmentalBenefitService.update || jest.fn();
