...
export class CgiarEntityDtoV2 extends BasicDto {
  ...
  @ApiProperty({
    type: () => BasicDto,
    description: 'Entity type (Center, CRP, Platform, etc.).',
  })
  ...
  @ApiProperty({
    required: false,
    description: 'End date of the entity (if no longer active).',
  })
  end_date: string;
  ...
  @ApiProperty({
    type: () => GlobalUnitLineageDto,
    isArray: true,
    required: false,
    description: 'Incoming lineage relations.',
  })
  ...
  @ApiProperty({
    ...
    isArray: true,
    required: false,
    description: 'Outgoing lineage relations.',
  })
