...
describe('HomepageClarisaEndpointController', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        { provide: HomepageClarisaEndpointService, useValue: mockHomepageClarisaEndpointService },
      ],
    }).compile();
  ...
  it('should be defined', () => {
    ...
    it('should call service on findAll', async () => {
      mockHomepageClarisaEndpointService.findAll = mockHomepageClarisaEndpointService.findAll || jest.fn();
    ...
    it('should call service on findOne', async () => {
      mockHomepageClarisaEndpointService.findOne = mockHomepageClarisaEndpointService.findOne || jest.fn();
    ...
    it('should call service on update', async () => {
      mockHomepageClarisaEndpointService.update = mockHomepageClarisaEndpointService.update || jest.fn();
