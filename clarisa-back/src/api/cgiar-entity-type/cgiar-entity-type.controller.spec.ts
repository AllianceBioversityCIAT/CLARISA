...
describe('CgiarEntityTypeController', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        { provide: CgiarEntityTypeService, useValue: mockCgiarEntityTypeService },
      ],
    }).compile();
  ...
  it('should be defined', () => {
    ...
    it('should call service on findAllV1', async () => {
      mockCgiarEntityTypeService.findAllV1 = mockCgiarEntityTypeService.findAllV1 || jest.fn();
    ...
    it('should call service on findOneV1', async () => {
      mockCgiarEntityTypeService.findOneV1 = mockCgiarEntityTypeService.findOneV1 || jest.fn();
    ...
    it('should call service on findAllV2', async () => {
      mockCgiarEntityTypeService.findAllV2 = mockCgiarEntityTypeService.findAllV2 || jest.fn();
    ...
    it('should call service on findOneV2', async () => {
      mockCgiarEntityTypeService.findOneV2 = mockCgiarEntityTypeService.findOneV2 || jest.fn();
