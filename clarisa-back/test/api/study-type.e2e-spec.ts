...
describe('Study types (e2e)', () => {
  ...
  it('/api/study-types/get/1 (GET)', () => {
    return request(app.getHttpServer())
      .get(`/api/study-types/get/1`)
      .expect(HttpStatus.OK)
      .expect((res) => {
        const data = res.body;
  ...
  it('/api/study-types/get/a (GET)', () => {
    return request(app.getHttpServer())
      .get('/api/study-types/get/' + 'a')
      .expect(400);
  });
