...
describe('TechnologyDevelopmentStageController', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        { provide: TechnologyDevelopmentStageService, useValue: mockTechnologyDevelopmentStageService },
      ],
    }).compile();
  ...
  it('should be defined', () => {
    ...
    it('should call service on findAll', async () => {
      mockTechnologyDevelopmentStageService.findAll = mockTechnologyDevelopmentStageService.findAll || jest.fn();
    ...
    it('should call service on findOne', async () => {
      mockTechnologyDevelopmentStageService.findOne = mockTechnologyDevelopmentStageService.findOne || jest.fn();
    ...
    it('should call service on update', async () => {
      mockTechnologyDevelopmentStageService.update = mockTechnologyDevelopmentStageService.update || jest.fn();
