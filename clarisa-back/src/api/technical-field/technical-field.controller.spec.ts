...
describe('TechnicalFieldController', () => {
  ...
  it('should call service on findAll', async () => {
    mockTechnicalFieldService.findAll =
      mockTechnicalFieldService.findAll || jest.fn();
  ...
  it('should call service on findOne', async () => {
    mockTechnicalFieldService.findOne =
      mockTechnicalFieldService.findOne || jest.fn();
  ...
  it('should call service on update', async () => {
    mockTechnicalFieldService.update =
      mockTechnicalFieldService.update || jest.fn();
