...
describe('ProjectedBenefitController', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        {
          provide: ProjectedBenefitService,
          useValue: mockProjectedBenefitService,
        },
      ],
    }).compile();
  ...
  it('should call service on findAll', async () => {
    mockProjectedBenefitService.findAll =
      mockProjectedBenefitService.findAll || jest.fn();
  ...
  it('should call service on findOne', async () => {
    mockProjectedBenefitService.findOne =
      mockProjectedBenefitService.findOne || jest.fn();
  ...
  it('should call service on update', async () => {
    mockProjectedBenefitService.update =
      mockProjectedBenefitService.update || jest.fn();
