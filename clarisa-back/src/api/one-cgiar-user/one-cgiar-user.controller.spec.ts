...
describe('OneCgiarUserController', () => {
  ...
  it('should be defined', () => {
    ...
    it('should call service on findAll', async () => {
      mockOneCgiarUserService.findAll = mockOneCgiarUserService.findAll || jest.fn();
    ...
    it('should call service on findOne', async () => {
      mockOneCgiarUserService.findOne = mockOneCgiarUserService.findOne || jest.fn();
    ...
    it('should call service on update', async () => {
      mockOneCgiarUserService.update = mockOneCgiarUserService.update || jest.fn();
