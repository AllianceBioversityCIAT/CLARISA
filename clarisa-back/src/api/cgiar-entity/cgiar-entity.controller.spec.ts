...
describe('CgiarEntityController', () => {
  ...
  it('should call service on findAllV1', async () => {
    mockCgiarEntityService.findAllV1 =
      mockCgiarEntityService.findAllV1 || jest.fn();
  ...
  it('should call service on findOneV1', async () => {
    mockCgiarEntityService.findOneV1 =
      mockCgiarEntityService.findOneV1 || jest.fn();
  ...
  it('should call service on findAllV2', async () => {
    mockCgiarEntityService.findAllV2 =
      mockCgiarEntityService.findAllV2 || jest.fn();
  ...
  it('should call service on getHierarchy', async () => {
    mockCgiarEntityService.getHierarchy =
      mockCgiarEntityService.getHierarchy || jest.fn();
    mockCgiarEntityService.getHierarchy.mockResolvedValue([]);

    try {
      await (controller as any).getHierarchy('active', {}, {}, {});
    } catch (_e) {
      /* ok */
    }
  });
  ...
  it('should call service on findOneV2', async () => {
    mockCgiarEntityService.findOneV2 =
      mockCgiarEntityService.findOneV2 || jest.fn();
  ...
  it('should call service on findByPortfolioV2', async () => {
    mockCgiarEntityService.findByPortfolioV2 =
      mockCgiarEntityService.findByPortfolioV2 || jest.fn();
    mockCgiarEntityService.findByPortfolioV2.mockResolvedValue([]);

    try {
      await (controller as any).findByPortfolioV2('active', {}, {}, {});
    } catch (_e) {
      /* ok */
    }
  });
