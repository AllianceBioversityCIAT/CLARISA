...
describe('InstitutionTypeController', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        { provide: InstitutionTypeService, useValue: mockInstitutionTypeService },
      ],
    }).compile();
  ...
  it('should be defined', () => {
    ...
    it('should call service on findAll', async () => {
      mockInstitutionTypeService.findAll = mockInstitutionTypeService.findAll || jest.fn();
    ...
    it('should call service on findAllSimple', async () => {
      mockInstitutionTypeService.findAllSimple = mockInstitutionTypeService.findAllSimple || jest.fn();
    ...
    it('should call service on findAllFromParentToChildren', async () => {
      mockInstitutionTypeService.findAllFromParentToChildren = mockInstitutionTypeService.findAllFromParentToChildren || jest.fn();
      mockInstitutionTypeService.findAllFromParentToChildren.mockResolvedValue([]);

      try { await (controller as any).findAllFromParentToChildren('active', {}, {}, {}); } catch (e) { /* ok */ }
    });

    it('should call service on findOne', async () => {
      mockInstitutionTypeService.findOne = mockInstitutionTypeService.findOne || jest.fn();
    ...
    it('should call service on update', async () => {
      mockInstitutionTypeService.update = mockInstitutionTypeService.update || jest.fn();
