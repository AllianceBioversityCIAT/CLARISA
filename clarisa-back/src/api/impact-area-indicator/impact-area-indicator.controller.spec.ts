...
describe('ImpactAreaIndicatorController', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        { provide: ImpactAreaIndicatorService, useValue: mockImpactAreaIndicatorService },
      ],
    }).compile();

    controller = module.get<ImpactAreaIndicatorController>(ImpactAreaIndicatorController);
  });
  ...
  it('should be defined', () => {
    ...
    it('should call service on findAll', async () => {
      mockImpactAreaIndicatorService.findAll = mockImpactAreaIndicatorService.findAll || jest.fn();
    ...
    it('should call service on findOne', async () => {
      mockImpactAreaIndicatorService.findOne = mockImpactAreaIndicatorService.findOne || jest.fn();
    ...
    it('should call service on update', async () => {
      mockImpactAreaIndicatorService.update = mockImpactAreaIndicatorService.update || jest.fn();
